...
const ProductDetailsTabs: React.FC<ProductDetailsTabsProps> = ({ product }) => {
  ...
  const reviews = [
    ...
    },
    {
      ...
      rating: 4,
      date: "2023-03-22",
      text: "Great product for the price. Would definitely recommend to friends.",
    },
    {
      id: 3,
      author: "Amanda K.",
      rating: 5,
      date: "2023-02-10",
      text: "Perfect gift for my friend. The colors are vibrant and the craftsmanship is excellent.",
    },
  ];
  ...
  const shippingInfo = {
    methods: [
      { name: "Standard Shipping", price: 414, time: "3-5 business days" },
      { name: "Express Shipping", price: 829, time: "1-2 business days" },
    ],
    returns:
      "Free returns within 30 days of delivery. Item must be unused and in original packaging.",
  };
  ...
  return (
    <Tabs defaultValue="description" className="w-full mt-12">
      <TabsList className="grid grid-cols-4 mb-8">
        <TabsTrigger
          value="description"
          className="data-[state=active]:bg-wolly-pink/20"
        >
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                Shipping times are estimated and may vary based on your
                location. You will receive a tracking number once your order
                ships.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                orders may be subject to customs fees and import duties, which
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                refund will be processed and automatically applied to your
