...
const Shop = () => {
  ...
  const defaultFilters = {
    categories: Array.isArray(queryFilters.category)
      ...
      ? [queryFilters.category]
      : [],
    priceRange: queryFilters.priceRange || ([0, 5000] as [number, number]),
  ...
  useEffect(() => {
    ...
    const searchTerm =
      currentParams.get("search") || currentParams.get("keyword");
              ...
              <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                  {savedCart.map((product) => (
                    <div
                      key={product.id}
                      className="bg-white dark:bg-gray-800 border border-border dark:border-gray-700 rounded-lg shadow-sm overflow-hidden"
                    >
                      <img
                        src={product.image}
                        alt={product.name}
                      ...
                      <div className="p-4">
                        ...
                        >
                          <ShoppingBag size={14} className="mr-1" /> Move to
                          Cart
                        </Button>
                      </div>
                    </div>
